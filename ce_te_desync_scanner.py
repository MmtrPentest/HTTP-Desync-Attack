...
if len(sys.argv) != 3:
    print""" 
    Usage   : ./ce_te_desync_scanner.py host URL Method
    Example : ./ce_te_desync_scanner.py www.victim.com POST /
    Info    : CL and TE Method Scanning 
    Author  : Lionel PRAT - lionel.prat9@gmail.com
    Update  : Haroon Awan - mrharoonawan@gmail.com    
    """    
    sys.exit(0)
